...
#if defined(WIFI_LORA_32_V3)||defined(WIFI_LORA_32_V4)||defined(WIFI_LORA_32_V2)||defined(WIRELESS_STICK_V3)||defined( WIFI_LORA_32 )||defined(WIRELESS_STICK)||defined(WIFI_LORA_32_V4_R8)
  void displayJoining();
  void displayJoined();
  void displaySending();
  void displayAck();
